    ...
    return (
      ...
      <div className="mx-auto flex max-w-[1240px] items-center justify-between gap-3 px-4 py-4 sm:px-6 md:px-8 md:py-5">
        ...
        <div className="flex shrink-0 items-center gap-4 text-sm font-semibold">
          <a href="#analyzer" className="hidden text-[#334155] transition hover:text-[#111827] sm:block">Login</a>
          <a href="#analyzer" className="rounded-full bg-gradient-to-r from-[#743cf1] to-[#367df5] px-3.5 py-2 text-xs font-bold text-white shadow-[0_6px_14px_rgba(67,91,229,0.22)] transition hover:-translate-y-0.5 sm:px-5 sm:py-2.5 sm:text-sm">
